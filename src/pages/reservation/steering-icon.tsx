export type SteeringIconProps = React.SVGProps<SVGSVGElement>;

export function SteeringIcon(props: SteeringIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-peace" viewBox="0 0 16 16" {...props}>
